-- Executed on 2023-09-06 10:05:31am 
...
SET @BookingIdsCSV = SUBSTRING((
    ...
    WHERE T0.U_BookingNumber IN ('I23344435NCB','I23344446STM','I23343119BMP','I23343532UTN','I23343193XPH','I23343499ENJ','I23343584FNG','I23342770FQD','I23342769BBD','I23342657DEV')
    FOR XML PATH (''), TYPE).value('text()[1]','nvarchar(max)'), 2, 10000000
);

DELETE FROM BILLING_EXTRACT WHERE U_BookingNumber IN ('I23344435NCB','I23344446STM','I23343119BMP','I23343532UTN','I23343193XPH','I23343499ENJ','I23343584FNG','I23342770FQD','I23342769BBD','I23342657DEV');
...
-- 2023-09-06 10:05:31am  [Microsoft][SQL Server Native Client 11.0][SQL Server]Column name or number of supplied values does not match table definition.