...
<?php
	$APInvoiceArr = array(
		"cardType" => "S",
		"taxCodeCategory" => "I",
		"mainFileName" => "ap-invoice",
		"objectTableName" => "A/P Invoice",
		"objectTable" => "OPCH",
		"objectType" => 18,
		"childTable1" => "PCH1",
		"childTable12" => "PCH12",
	...
	$_SESSION['APInvoiceArr'] = json_encode($APInvoiceArr);

	$_SESSION['cardType'] = $APInvoiceArr['cardType'];
	$_SESSION['mainFileName'] = $APInvoiceArr['mainFileName'];
	$_SESSION['objectTableName'] = $APInvoiceArr['objectTableName'];
	$_SESSION['objectTable'] = $APInvoiceArr['objectTable'];
	$_SESSION['objectType'] = $APInvoiceArr['objectType'];
?>

	<script type="text/javascript">
		let obj = JSON.parse('<?php echo $_SESSION['APInvoiceArr']; ?>');
          ...
          <div class="modal-body" >
			...
			<div class="form-group row   my-1" >
				...
				<div class="input-group mb-1 col-sm-9">
						...
						<input  type="text" id="txtStatesSName" class="form-control shipInputs" placeholder="" readonly>
						<div class="input-group-append">
...
<script>$('#tblCountryS').dataTable({"bLengthChange": false,});</script>
<script>$('#tblCountryB').dataTable({"bLengthChange": false,});</script>
<script>$('#tblStatesS').dataTable({"bLengthChange": false,});</script>
