...
$truckerShare = (float)$U_OtherCharges;


        $rowTotal = ($U_GrossTruckerRatesTotal+$U_AddtlChargesAmountTotal+$truckerShare);
        ...
        $totalTruckerShare += $truckerShare;
        ...
        $htmldetails .= '<tr>
                            ...
                            <td align="center">'.number_format($truckerShare,2).'</td>
   ...
   $totalU_TotalPayable2 = 0.00;
    ...
    $net = $totalU_TotalPayable - $wt;
        $htmldetailsFooter .= '<tr>
                            ...
                            <td align="center"><b>'.number_format($totalTruckerShare,2).'</b></td>
                ...
                <table  width="100%" border=1> 
                    <thead  >
                        <tr  >
                            ...
                            <th max-width="10px"><center><h5>Penalty Adjustment</h5></center></th>
