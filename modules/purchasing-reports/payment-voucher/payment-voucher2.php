...
CASE
    WHEN ISNULL( T2.VatStatus,'Y') = 'N' THEN 'Nonvat'
    WHEN ISNULL( T2.VatStatus,'Y') = 'Y' THEN 'Vat'
...
T1.U_ClientName,
T1.U_PlateNumber,
T6.Name AS U_VehicleTypeCap,
CAST(T1.U_DeliveryOrigin AS NVARCHAR(250)) AS U_DeliveryOrigin,
CAST(T1.U_Destination AS NVARCHAR(250)) AS U_Destination,
T1.U_NoOfDrops,

CONVERT(VARCHAR(10),DATEADD(day, CAST(ISNULL(T3.U_CDC,0) AS INT), T1.U_DeliveryDateDTR),23) AS U_PODSubmitDeadline,
...
T2.LicTradNum,
   ...
   ISNULL(PU.U_TotalSubPenalty, 0) AS U_TotalSubPenalty,
    ISNULL(PU.U_TotalPenaltyWaived, 0) AS U_TotalPenaltyWaived,
 ISNULL(PU.U_TotalPenalty, 0) AS U_TotalPenalty
...
LEFT JOIN [@VEHICLETYPEANDCAP] T6 ON T6.Code = T1.U_VehicleTypeCap
LEFT JOIN TP_EXTRACT TF ON TF.U_BookingId = T0.U_BookingId

LEFT JOIN BILLING_EXTRACT BE ON BE.U_BookingNumber = T0.U_BookingId
LEFT JOIN PCTP_UNIFIED PU ON PU.U_BookingNumber = T0.U_BookingId
...
while (odbc_fetch_row($qry)) {
        ...
        $U_TotalPenalty =number_format(odbc_result($qry, 'U_TotalSubPenalty'),2);
...
$U_AddtlChargesAmountTotal=
        ...
        $rowTotal = ($U_GrossTruckerRatesTotal+$U_AddtlChargesAmountTotal)-(odbc_result($qry, 'U_TotalPenalty'));
        ...
        $htmldetails .= '<tr>
                            ...
                            <td align="center">'.$U_PlateNumber.'</td>
                            <td align="center">'.$U_VehicleTypeCap.'</td>
                            <td align="center">'.$U_DeliveryOrigin.'</td>
                            <td align="center">'.$U_Destination.'</td>
                            <td align="center">'.$U_NoOfDrops.'</td>
   ...
   $totalU_TotalPayable2 = 0.00;
    ...
    $net = $totalU_TotalPayable - $wt;
        $htmldetailsFooter .= '<tr>
                            <td align="center" colspan="14"><b>TOTAL AMOUNT</b></td>
                        ...
                        <tr>
                            <td align="center" colspan="14"><b>LESS: 2% Creditable Withholding Tax</b></td>
                            <td align="center"></td>
                            <td align="center"></td>
                            <td align="center"></td>
                            <td align="center"></td>
                        ...
                        <tr>
                            <td align="center" colspan="14"><b>NET AMOUNT</b></td>
                            <td align="center"></td>
                            <td align="center"></td>
                            <td align="center"></td>
                            <td align="center"></td>
                ...
                <table  width="100%" border=1> 
                    <thead  >
                        <tr  >
                            ...
                            <th max-width="10px"><center><h5>Plate Number</h5></center></th>
                            <th max-width="10px"><center><h5>Fleet Type</h5></center></th>
                            <th max-width="10px"><center><h5>Delivery Origin</h5></center></th>
                            <th max-width="10px"><center><h5>Destination</h5></center></th>
                            <th max-width="10px"><center><h5>No. of Drops</h5></center></th>
                            ...
                            <th max-width="10px"><center><h5>Trucker Rate</h5></center></th>
                            <th max-width="10px"><center><h5>Additional Charges</h5></center></th>
                            <th max-width="10px"><center><h5>Total Penlaty</h5></center></th>
                           <th max-width="10px"><center><h5>Waived Penalties</h5></center></th>
