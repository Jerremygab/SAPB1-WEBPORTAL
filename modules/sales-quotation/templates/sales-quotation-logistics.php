...
<div style="padding-top:10px;">
	<div class="row" style="padding-bottom:10px;">
		...
		<!-- checkbox -->
		<div class="col-xl-3 col-lg-3 col-md-3 col-sm-3">
		<label class="col-sm-7 col-form-label " style="color: black; display: flex; align-items: center">
		<input type="checkbox" id="chkPayNoDoc" style=" height:20px ; width:20px; margin-right:10px" class="form-control matrix-cell" > Procedure Non Drop-Ship Items </label>
		<label class="col-sm-7 col-form-label " style="color: black; display: flex; align-items: center">
		<input type="checkbox" id="chkPayNoDoc" style=" height:20px ; width:20px; margin-right:10px" class="form-control matrix-cell" checked > Procedure Non Drop-Ship Items </label>
		</div>
