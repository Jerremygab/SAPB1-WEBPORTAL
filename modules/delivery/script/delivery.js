 ...
 */
 ...
 $(document.body).on('click', '#tblSO tbody tr td', function () 
	{
		...
		// {
			...
			if($(this).closest('tr').find('td:eq(1) input').is(":checked")){
				...
				pid = parseInt($(this).closest('tr').find('td:eq(2)').text());
					multiCopyFromSO.push(pid);
					
				
			}else{
				var index = multiCopyFromSO.indexOf(parseInt($(this).closest('tr').find('td:eq(2)').text()));
					if (index !== -1) {
					  multiCopyFromSO.splice(index, 1);
					  console.log(multiCopyFromSO)
					}
			}
			console.log(multiCopyFromSO)
...
$(document.body).on('click', '#multiCopyFromSO', function () 
	{
		console.log('test')


		if(multiCopyFromSO.length > 0){

			var docNum = multiCopyFromSO;
			var docType = 'I';
			var objType = 17;
...
//Double Clicks
	...
	$(document.body).on('dblclick', '#tblBP tbody > tr', function () 
	{
		...
		let txtFatherCard = $(this).children('td.item-10').text();
		let addressID = '';
		...
		$('#txtFatherCard').val(txtFatherCard);
...
//Search
	...
	$(document.body).on('click', '#btnAdd', function () 
	{
		...
		var txtFatherCard = $('#txtFatherCard').val();
