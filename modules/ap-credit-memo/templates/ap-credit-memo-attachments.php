  ...
  <tbody class="">
    <tr style="background-color: white; ">
	     ...
	     <td >
		  ...
		  <td >
				<div class="input-group ">
					<input type="file" name="file" class="form-control matrix-cell file"  aria-label="File Name" aria-describedby="button-addon2" style="outline: none; border:none" readonly/>
				</div>
		  </td>
		  <td >
		  	<div class="input-group ">
		  ...
		  <td>
				<div class="input-group ">
					<input type="text" class="form-control matrix-cell freetext" aria-label="Recipient's username" aria-describedby="button-addon2" style="outline: none; border:none;" />
				</div>
		  </td>
    </tr>
  </tbody>
