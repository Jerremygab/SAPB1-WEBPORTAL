...
<div id="wrapper">
                            ...
                            <div class="card-header py-0"
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <h5 class="mt-2 font-weight-bold " style="color: black;"> A/P Credit Memo </h5>
                                    </div>
                                        ...
                                        <div class="col-lg-4 pb-2 " id="dateCol">
                                            <div class="form-group row  py-0 my-0 mb-1">
												...
												$qry = odbc_exec($MSSQL_CONN, "USE [".$MSSQL_DB."]; SELECT DISTINCT
																											...
																											FROM NNM1 T0
																											WHERE T0.SeriesName = 'Primary' AND ObjectCode = 19 
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 text-right">
                                            <span class="dropdown mr-5">
                                                ...
                                                <ul class="dropdown-menu " aria-labelledby="btnCopyFrom"
                                                    ...
                                                    <!-- <li><button type="button" id="btnCopyFromGR" class="dropdown-item"
                                                            style="color: black; font-weight: bold; font-size:15px;"
                                                            data-toggle="modal" data-target=""
                                                            data-backdrop="false">Goods Return</button></li> -->

                                                    <li><button type="button" id="btnCopyFromAPI" class="dropdown-item"
                                                            style="color: black; font-weight: bold; font-size:15px;"
                                                            data-toggle="modal" data-target="#apInvoiceModal"
                                                            data-backdrop="false">A/P Invoices</button></li>

                                                    <!-- <li><button type="button" id="btnCopyFromAPDP" class="dropdown-item"
                                                            style="color: black; font-weight: bold; font-size:15px;"
                                                            data-toggle="modal" data-target="#apDownpaymentModal"
                                                            data-backdrop="false">A/P Down Payment</button></li> -->
                                                </ul>
                                            </span>
                                        </div>
      ...
      <div class="modal-dialog modal-xl" role="document" style="width:100%">
        ...
        <div class="modal-content-full-width modal-content">
          ...
          <div class="modal-header"  style="background-color: #A8A8A8; border-bottom-width: thick; border-color: #f0ad4e;">
            <h4 class="modal-title w-100" id="myModalLabel" style="color:black">List of AP Credit Memo</h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
 ...
 <div class="modal fade" id="" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog modal-xl" role="document" style="width:100%">
            ...
            <div class="modal-content-full-width modal-content">
                ...
                <div class="modal-header"
                    style="background-color: #A8A8A8; border-bottom-width: thick; border-color: #f0ad4e;">
                    <h4 class="modal-title w-100" id="myModalLabel" style="color:black">List of Goods Return</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <!--Body-->
                <div class="modal-body">
                    <table class="table table-striped table-bordered table-hover " id="tblGR">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th class="">Doc No.</th>
    ...
    <!-- Copy From AP Invoice Modal -->
    <div class="modal fade" id="apInvoiceModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document" style="width:100%">
            <!--Content-->
            <div class="modal-content-full-width modal-content">
                ...
                <div class="modal-header"
                    style="background-color: #A8A8A8; border-bottom-width: thick; border-color: #f0ad4e;">
                    <h4 class="modal-title w-100" id="myModalLabel" style="color:black">List of A/P Invoice</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
 ...
 <!-- Copy From AP Downpayment Invoice Modal -->
 <div class="modal fade" id="apDownpaymentModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document" style="width:100%">
            <!--Content-->
            <div class="modal-content-full-width modal-content">
                ...
                <!--Body-->
                <div class="modal-body">
                    <table class="table table-striped table-bordered table-hover " id="tblAPD">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th class="">Doc No.</th>
...
<!-- Item Code Modal -->
   ...
   <div class="modal fade" id="controlAccountModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <script src="../script/ap-credit-memo.js"></script>
