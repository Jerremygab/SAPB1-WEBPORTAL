    ...
    <table id="tblDetails" class="table table-striped table-bordered table-sm detailsTable" cellspacing="0"
        ...
        <thead style="border-bottom: 0 !important;">
            <tr>
                ...
                <th style="color: black; min-width:150px;">Wtax Liable</th>
            ...
            <tr style="background-color: white; ">
                ...
                <td>
                    <input type="text" class="form-control matrix-cell text-right quantity" aria-label=""
                        aria-describedby="button-addon2" style="outline: none; border:none" maxlength="20" />
            ...
            <tr style="background-color: white; ">
                ...
                <td>
                    <input type="text" class="form-control matrix-cell glname" aria-label=""
                        aria-describedby="button-addon2" style="outline: none; border:none" maxlength="20" readonly />

                </td>
                <td class="d-none">
                    <input type="text" class="form-control matrix-cell text-right quantity" aria-label=""
                        aria-describedby="button-addon2" style="outline: none; border:none" maxlength="20" value="1" />
