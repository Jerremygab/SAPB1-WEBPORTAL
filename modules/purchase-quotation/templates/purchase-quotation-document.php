...
<div id="wrapper">
                            ...
                            <div class="card-header py-0"
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <h5 class="mt-2 font-weight-bold " style="color: black;">Purchase Quotation</h5>
                                    </div>
                                        ...
                                        <div class="col-lg-4 pb-2 " id="dateCol">
                                            <div class="form-group row  py-0 my-0 mb-1">
												...
												$qry = odbc_exec($MSSQL_CONN, "USE [".$MSSQL_DB."]; SELECT DISTINCT
																											...
																											FROM NNM1 T0
																											WHERE T0.SeriesName = 'Primary' AND ObjectCode = 540000006
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 text-right">
                                            <span class="dropdown mr-5">
                                                ...
                                                <ul class="dropdown-menu " aria-labelledby="btnCopyFrom"
                                                    ...
                                                    <li><button type="button" id="btnCopyFromPR" class="dropdown-item"
                                                            style="color: black; font-weight: bold; font-size:15px;"
                                                            data-toggle="modal" data-target="#purchaseRequestModal"
                                                            data-backdrop="false">Purchase Request</button></li>
                                                </ul>
                                            </span>
                                        </div>
    ...
    <!-- Copy From PR Modal -->
    <div class="modal fade" id="purchaseRequestModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document" style="width:100%">
            <!--Content-->
            <div class="modal-content-full-width modal-content">
...
<div class="modal fade" id="Ocr1Modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
   ...
   <div class="modal fade" id="glModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <script src="../script/purchase-quotation.js"></script>
