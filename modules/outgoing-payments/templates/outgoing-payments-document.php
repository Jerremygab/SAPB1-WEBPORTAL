...
<div id="wrapper">
                            ...
                            <div class="card-header py-0"
                                ...
                                <div class="row" id="window-header">
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <h5 class="mt-2 font-weight-bold " style="color: black;">Outgoing Payments</h5>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="documentModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog modal-xl" role="document" style="width:100%">
            ...
            <div class="modal-content-full-width modal-content">
                ...
                <div class="modal-header"
                    style="background-color: #A8A8A8; border-bottom-width: thick; border-color: #f0ad4e;">
                    <h4 class="modal-title w-100" id="myModalLabel" style="color:black">List of Outgoing Payments</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    <thead>
                        ...
                        <tbody>
							...
							$qry = odbc_exec($MSSQL_CONN, "USE [".$MSSQL_DB."]; SELECT DISTINCT
																						...
																						WHERE T0.CardType = 'S' AND T0.CardCode = '$txtCardCodeSearch' OR T0.CardName = '$txtCardCodeSearch'
    ...
    <!-- UDF -->
    <script src="../script/outgoing-payments-utilities.js"></script>
    <script src="../script/outgoing-payments.js"></script>
