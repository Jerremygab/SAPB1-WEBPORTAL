...
<?php
	$APDownpaymentArr = array(
		"cardType" => "S",
		"taxCodeCategory" => "I",
		"mainFileName" => "ap-downpayment-invoice",
		"objectTableName" => "A/P Downpayment Invoice",
		"objectTable" => "ODPO",
		"objectType" => 204,
		"childTable1" => "DPO1",
		"childTable12" => "DPO12",
		...
		"copyFromArr" => array(
			array(
				"baseTableName" => "Purchase Order",
				"baseTable" => "OPOR",
				"baseChildTable1" => "POR1",
				"baseType" => 22,
				"copyFromModal" => 'purchaseOrder',

			),
			array(
				"baseTableName" => "Goods Receipt PO",
				"baseTable" => "OPDN",
				"baseChildTable1" => "PDN1",
				"baseType" => 20,
				"copyFromModal" => 'goodsreceiptPO',
				"copyFromModalTbl" => 'GRPO'
			)
		)
	);

	$_SESSION['APDownpaymentArr'] = json_encode($APDownpaymentArr);

	$_SESSION['cardType'] = $APDownpaymentArr['cardType'];
	$_SESSION['mainFileName'] = $APDownpaymentArr['mainFileName'];
	$_SESSION['objectTableName'] = $APDownpaymentArr['objectTableName'];
	$_SESSION['objectTable'] = $APDownpaymentArr['objectTable'];
	$_SESSION['objectType'] = $APDownpaymentArr['objectType'];
?>

	<script type="text/javascript">
		let obj = JSON.parse('<?php echo $_SESSION['APDownpaymentArr']; ?>');
                            ...
                            <div class="card-header py-0"
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <h5 class="mt-2 font-weight-bold " style="color: black;"> A/P Downpayment Invoice </h5>
                                    </div>
                                        ...
                                        <div class="col-lg-4 pb-2 " id="dateCol">
                                            <div class="form-group row  py-0 my-0 mb-1">
												...
												$qry = odbc_exec($MSSQL_CONN, "USE [".$MSSQL_DB."]; SELECT DISTINCT
																											...
																											FROM NNM1 T0
																											WHERE T0.SeriesName = 'Primary' AND ObjectCode = 204
								...
								?> readonly>
                                            ...
                                            <div class="form-group row  py-0 my-0">
                                                ...
                                                <div class="col-sm-6 input-group mb-1 ">
                                                    <input type="date" id="txtPostingDate" class="form-control postingdate"
                                            ...
                                            <div class="form-group row  py-0 my-0">
                                                ...
                                                <div class="col-sm-6 input-group mb-1">
                                                    <input type="date" id="txtDocumentDate" class="form-control"
                                                        value="<?php echo date('Y-m-d'); ?>" min="01-01-2018"
                                                        max="12-31-2050">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row  mb-0">
                                                <div class="col-sm-4 row">
                                                    ...
                                                    <select id="selTransactionType"
                                                        ...
                                                        style="outline:none; border-color: #D0D0D0 !important;">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 text-right">
                                            <span class="dropdown mr-5">
                                                ...
                                                <ul class="dropdown-menu " aria-labelledby="btnCopyFrom"
                                                    ...
                                                    <li><button type="button" id="btnCopyFromPQ" class="dropdown-item"
                                                            style="color: black; font-weight: bold; font-size:15px;"
                                                            data-toggle="modal" data-target="#purchaseQoutationModal"
                                                            data-backdrop="false">Purchase Quotation</button></li>
                                                    ...
                                                    <li><button type="button" id="btnCopyFromGRPO" class="dropdown-item"
                                                            style="color: black; font-weight: bold; font-size:15px;"
                                                            data-toggle="modal" data-target="#goodReceiptModal"
                                                            data-backdrop="false">Goods Receipt PO</button></li>
                                                </ul>
                                            </span>
                                        </div>
    ...
    <!-- Copy From PQ Modal -->
    <div class="modal fade" id="purchaseQoutationModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document" style="width:100%">
            <!--Content-->
            <div class="modal-content-full-width modal-content">
                ...
                <div class="modal-header"
                    style="background-color: #A8A8A8; border-bottom-width: thick; border-color: #f0ad4e;">
                    <h4 class="modal-title w-100" id="myModalLabel" style="color:black">List of Purchase Quotation</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <!-- Copy From GRPO Modal -->
    <div class="modal fade" id="goodReceiptModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document" style="width:100%">
            <!--Content-->
            <div class="modal-content-full-width modal-content">
                ...
                <div class="modal-header"
                    style="background-color: #A8A8A8; border-bottom-width: thick; border-color: #f0ad4e;">
                    <h4 class="modal-title w-100" id="myModalLabel" style="color:black">List of Good Receipt PO</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    <thead>
                        ...
                        <tbody>
							...
							--DISTINCT
																						...
																						WHERE T0.CardType = 'S' AND T0.CardCode = '$txtCardCodeSearch'
																						...
																						WHERE T0.CardType = 'S' AND T0.CardName = '$txtCardCodeSearch'
   ...
   <div class="modal fade" id="glModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row   my-1">
                        ...
                        <div class="input-group mb-1 col-sm-9">
                            <input type="text" id="txtStatesS" class="form-control shipInputs d-none" placeholder="">
    ...
    <script src="../script/ap-downpayment-invoice.js"></script>
