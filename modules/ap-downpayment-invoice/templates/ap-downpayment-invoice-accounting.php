        ...
        <div class="row" style="padding-top:10px">
            <div class="col-lg-12">
                <div class="form-group row py-0 my-0">
                    ...
                    <div class="col-sm-9">
                        <div class=" mb-1">
                            <input readonly type="text" id="txtJournalMemo" class="form-control" placeholder=""
				...
				<label class=" col-form-label " style="color: black;" >Control Account</label>
					...
					<div class="col-sm-9" >
						<div class="input-group mb-1">
                            ...
                            <input readonly type="text" id="txtControlAccountCode" class="form-control" placeholder="" aria-label="Username" aria-describedby="basic-addon1 " style="border-bottom-left-radius:5px; border-top-left-radius:5px;">
							<input readonly type="text" id="txtControlAccountName" class="form-control  d-none" placeholder="" aria-label="Username" aria-describedby="basic-addon1 " style="border-bottom-left-radius:5px; border-top-left-radius:5px;">
                        ...
                        <div class="input-group mb-1">
                            <div class="input-group-prepend d-none" id="lnkCardCode">
                                <button class="btn" type="button" data-mdb-ripple-color="dark"
                                    style="background-color: #ADD8E6;" data-toggle="modal" data-target="#bpMasterModal"
                                    data-backdrop="false">
                                    <i class="fas fa-arrow-right  " style="color: #FFD700; font-size:20px"></i>
                                </button>
                            </div>
                            <input readonly type="text" id="txtPaymentTermsCode" class="form-control d-none"
                                placeholder="" aria-label="Username" aria-describedby="basic-addon1 "
                                style="border-bottom-left-radius:5px; border-top-left-radius:5px;">
                            <input readonly type="text" id="txtPaymentTermsName" class="form-control" placeholder=""
                                aria-label="Username" aria-describedby="basic-addon1 "
                                style="border-bottom-left-radius:5px; border-top-left-radius:5px;">
                            <div class="input-group-append">
                                <button id="btnPaymentTerms" class="btn btnGroup" type="button"
                                    data-mdb-ripple-color="dark" style="background-color: #ADD8E6; " data-toggle="modal"
                                    data-target="#paymentTermsModal" data-backdrop="false">
                                    <i class="fas fa-list-ul input-prefix" tabindex=0 style="color:blue "></i>
                                </button>
                            </div>
                        </div>
            ...
            <div class="col-lg-12">
                <div class="form-group row  py-0 my-0">
                    ...
                    <div class="col-sm-9 input-group mb-1">
                        <input type="date" id="txtCancellationDate" class="form-control" placeholder=""
                            aria-label="Username" aria-describedby="basic-addon1" value="<?php 
                ...
                <div class="form-group row  py-0 my-0">
                    ...
                    <div class="col-sm-9 input-group mb-1">
                        <input type="date" id="txtRequiredDate" class="form-control" placeholder=""
                            aria-label="Username" aria-describedby="basic-addon1" value="<?php echo date('Y-m-d'); ?>"
                            min="2018-01-01" max="2050-12-31">
                    </div>
                </div>
