				...
				<div class="card-body " id="window" style="background-color: #F5F5F5; border-right: 1px solid #A0A0A0">
					<form class="user responsive " id="form"  width="100%">
						<div class="text-right mt-5">
								<button type="button" id="btnCreateNew"  class="  btn btn-warning btn-rounded " style="color: black; font-weight: bold; width:250px; background: linear-gradient(to bottom, #FCF6BA, #BF953F);" data-toggle="modal" data-target="#approvalModal" data-backdrop="false" >Create New</button>
						</div>
      ...
      <div class="modal-dialog modal-xl" role="document" style="width:100%">
        ...
        <div class="modal-content-full-width modal-content">
          ...
          <div class="modal-header"  style="background-color: #A8A8A8; border-bottom-width: thick; border-color: #f0ad4e;">
            <h4 class="modal-title w-100" id="myModalLabel" style="color:black">List of Approval</h4>
								...
								<div class="tab-pane fade show active" id="modules" role="tabpanel" aria-labelledby="contents">
									...
									<div id="contentContainer2"class="table-responsive" style="width:100%; padding-bottom:20px; padding-left:10px;  overflow-x:hidden;  overflow-y:hidden;" >
										<div id="approval-tab">
											<div class="row">
												<div class="col-6">
													<label for="inputEmail3" class=" col-form-label " style="color: black;" >Approvers</label>
													<div id="contentContainer"class="table-responsive" style="width:100%; padding-bottom:20px; padding-left:10px;  overflow-x:hidden;  overflow-y:hidden;" >
													<div id="users-tab">
													</div>
													<hr/>
...
<script>$('#tblUserApproval').dataTable({"bLengthChange": false,});</script>
<script>$('#tblTemplateApproval').dataTable({"bLengthChange": false,});</script>
<script>$('#tblQuery').dataTable({"bLengthChange": false,});</script>
