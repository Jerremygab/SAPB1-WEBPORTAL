...
while (odbc_fetch_row($qry)) 
{
	...
	$CardCode = odbc_result($qry, "LineVendor");
	$PQTReqDate = date('Y-m-d' ,strtotime(odbc_result($qry, 'PQTReqDate')));
		...
		$disabled = 'disabled';
				...
				if($docType == 'I'){
					...
					'<tr style="background-color: white; "  >
					  ...
					  <td >
						<div class="'.$inputGroup.' ">
						<input type="text" class="form-control matrix-cell cardcode"  style="outline: none; border:none" readonly  value="'.$CardCode.'"/>
						  <button class="btn '.$buttonHide.' " type="button" data-mdb-ripple-color="dark"  style="background-color: #ADD8E6; "  data-toggle="modal" data-target="#bpModalRow" data-backdrop="false">
							<i class="fas fa-list-ul input-prefix" tabindex=0 style="color:blue " ></i>
						  </button>
						</div>
					  </td>
					  <td class="row">
						...
						<input type="date" class="form-control  matrix-cell requireddate" style="outline: none; border:none" placeholder=""  value="'.$PQTReqDate.'" min="2018-01-01" max="2050-12-31" '.$readonly.'>
					...
					echo '<tr style="background-color: white; "  >
						  ...
						  <td >
						   ...
						   <td >
								<div class="'.$inputGroup.' ">
									<input type="text" class="form-control text-right  taxamount d-none"  value="'.$TaxAmount2.'"  style="outline: none; border:none" maxlength="8"/>
									<select type="text" class="form-control taxcode"  placeholder="" '.$disabled.'>
												 '.$taxcode.'
													</select>
								</div>
	...
	if($DocStatus == 'O'){
	  ...
	  <td >
	   ...
	   <td >
	    ...
	    <td >
		<div class="'.$inputGroup.' ">
		<input type="text" class="form-control matrix-cell cardcode"   style="outline: none; border:none" readonly/>
		  <button class="btn '.$buttonHide.' " type="button" data-mdb-ripple-color="dark"  style="background-color: #ADD8E6; "  data-toggle="modal" data-target="#bpModalRow" data-backdrop="false">
			<i class="fas fa-list-ul input-prefix" tabindex=0 style="color:blue " ></i>
		  </button>
		</div>
	   ...
	   <td class="row">
		...
		<input type="date" class="form-control  matrix-cell requireddate" style="outline: none; border:none" placeholder=""  value="'.$date.'" min="2018-01-01" max="2050-12-31">
