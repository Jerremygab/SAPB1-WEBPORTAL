...
<div class="">
    <table id="tblDetails" class="table table-striped table-bordered table-sm detailsTable" cellspacing="0"
        style="background-color: white; width= 100%" cellspacing="0">
        <thead style="border-bottom: 0 !important">
            <tr>
                <th class="text-right" style=" color: black;">#</th>
                <th style="color: black; min-width:200px; ">Item No.</th>
                <th style="color: black; min-width:400px; ">Item Description</th>
                <th style="color: black; min-width:200px; ">UoM Code</th>
                <th style="color: black; min-width:200px;">Vendor</th>
                <th style="color: black; min-width:150px;">Required Date</th>
                <th style="color: black; width:100px; min-width:100px;">Required Qty</th>
                <th style="color: black; min-width:150px;">Info Price</th>
        ...
        <tbody class="">
            <tr style="background-color: white; ">
                ...
                <td>
                    <div class="input-group ">
                        ...
                        <button class="btn " type="button" data-mdb-ripple-color="dark"
                            style="background-color: #ADD8E6; " data-toggle="modal" data-target="#itemModal"
                            data-backdrop="false">
                ...
                <td>
                    <div class="input-group ">
                        <input type="text" class="form-control matrix-cell unitmsr" aria-label="Recipient's username"
                            aria-describedby="button-addon2" style="outline: none; border:none;" readonly />
                        <button class="btn " type="button" data-mdb-ripple-color="dark"
                            style="background-color: #ADD8E6; " data-toggle="modal" data-target="#uomModal"
                            data-backdrop="false">
                            <i class="fas fa-list-ul input-prefix" tabindex=0 style="color:blue "></i>
                        </button>
                ...
                <td>
                    <div class="input-group ">
                        <input type="text" class="form-control matrix-cell cardcode" aria-label="Recipient's username"
                            aria-describedby="button-addon2" style="outline: none; border:none;" readonly />
                        <button class="btn " type="button" data-mdb-ripple-color="dark"
                            style="background-color: #ADD8E6; " data-toggle="modal" data-target="#bpModalRow"
                            data-backdrop="false">
                            <i class="fas fa-list-ul input-prefix" tabindex=0 style="color:blue "></i>
                        </button>
                    </div>
                ...
                <td class="row">
                    <input type="date" class="form-control  matrix-cell "
                ...
                <td>
                    <input type="text" class="form-control matrix-cell text-right discount"
                        style="outline: none; border:none;" maxlength="8" />

                </td>
                <td>
                    <div class="input-group ">
                        <input type="text" class="form-control text-right d-none taxamount"
                            style="outline: none; border:none;" maxlength="8" />
                ...
                <td>
                    <input type="text" class="form-control matrix-cell text-right rowtotal "
                        aria-label="Recipient's username" aria-describedby="button-addon2"
                        style="outline: none; border:none;" readonly />
                </td>
                <td>
                    <input type="text" class="form-control matrix-cell text-right grosstotal "
                        aria-label="Recipient's username" aria-describedby="button-addon2"
                        style="outline: none; border:none;" readonly />
                </td>
    ...
    <table id="tblDetails" class="table table-striped table-bordered table-sm detailsTable" cellspacing="0"
        ...
        <thead style="z-index: 999;  background-color: lightgray;  !important" class="thead-fixed " style="">
            <tr style="background-color: lightgray; z-index: 999; !important">
                ...
                <th style="color: black; min-width:200px;">G/L Account</th>
                <th style="color: black; min-width:300px;">G/L Name</th>
                <th style="color: black; min-width:200px;">Preferred Vendor</th>
                <th style="color: black; min-width:150px;">Required Date</th>
        ...
        <tbody class="">
            <tr style="background-color: white; ">
                ...
                <td>
                    <input type="date" class="form-control  matrix-cell requireddate"
                        style="outline: none; border:none;" placeholder="" aria-label="Username"
                        aria-describedby="basic-addon1" value="<?php echo date('Y-m-d'); ?>" min="2018-01-01"
                        max="2050-12-31">
                ...
                <td>
                <input type="text" class="form-control matrix-cell text-right discount" aria-label=""
                        aria-describedby="button-addon2" style="outline: none; border:none" maxlength="8" />
