...
<table id="tblMain" class="table table-striped table-bordered table-hover table-lg detailsTable"   style="background-color: white; width= 100%">
	<thead style="border-bottom: 0 !important">
		<tr>
			...
			<th style="color: black; white-space: nowrap ">Error Message</th>
			...
			<th style="color: black; white-space: nowrap ">ISLAND (ORIGIN)</th>
			<th style="color: black; white-space: nowrap ">Destination&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
			<th style="color: black; white-space: nowrap ">ISLAND (DESTINATION)</th>

			<th style="color: black; white-space: nowrap  ">if INTERISLAND</th>
			<th style="color: black; white-space: nowrap  ">Delivery Status</th>
			<th style="color: black; white-space: nowrap  ">Delivery Completion Date(PER DTR)</th>
			<th style="color: black; white-space: nowrap  ">Delivery Complete Date (PER POD)</th>
			<th style="color: black; white-space: nowrap  ">No. of drops on trip ticket</th>
			...
			<th style="color: black; white-space: nowrap; max-width:400px">Series No.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
			...
			<th style="color: black; white-space: nowrap  ">Actual date received Soft copy (Initial)</th>
			...
			<th style="color: black; white-space: nowrap  ">Date returned by POD to Truckers (Hardcopy)</th>
			...
			<th style="color: black; white-space: nowrap  ">Date forwarded to BT (Hard copy)</th>
			<th style="color: black; white-space: nowrap  ">POD Turn around time</th>
			...
			<th style="color: black; white-space: nowrap  ">I - Penalty Caculation(-)</th>
