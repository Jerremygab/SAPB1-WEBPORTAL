...
$selectedBatchAdded = $_GET['selectedBatchAdded'];
?>
...
$qry = odbc_exec($MSSQL_CONN, "USE [".$MSSQL_DB."];
	...
	INNER JOIN OIGN T2 ON T2.DocNum = T0.BaseNum 
	INNER JOIN IGN1 T3 ON T3.LineNum = T0.BaseLinNum AND T3.DocEntry = T0.BaseEntry
	...
	AND T0.BatchNum = '$selectedBatchAdded'
...
while (odbc_fetch_row($qry)) 
{
	...
	$CardName = odbc_result($qry, "AcctName");
...
$i = 1;
	...
	<tr style="background-color: white; "  >
		...
		<td class="docnumber">SI '.$BaseNum.'</td>
