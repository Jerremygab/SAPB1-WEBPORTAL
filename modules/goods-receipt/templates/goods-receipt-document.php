...
?>
		   ...
		   <div class="row pr-0 "  width="100%">
            ...
            <div class="card-header py-0" style="background-color: #A8A8A8; border-bottom-width: thick; border-color: #f0ad4e;">
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-6">
						<h5 class="mt-2 font-weight-bold " style="color: black;">Goods Receipt</h5>
					</div>
				</div>
            </div>
			...
			<form class="user responsive " id="salesOrder"  width="100%">
				...
				<div class="col-lg-2 pb-2" >
					...
					<div class="col-lg-3 pb-2  "  width="100%" id="midCol">
				...
				<div class="row pr-0 "  width="100%">
					...
					<div class="col-lg-8 pb-2  "  width="100%" id="midCol">
						<div class="form-group row  py-0 my-0 mb-1" >
						<label for="inputEmail3" class="col-sm-1 col-form-label " style="color: black;" >Price List</label>
							<div class="col-sm-7" >
								<select type="text" class="form-control " id="selPriceList" placeholder=""    >
										<option class="pricelist" value='-1'>Last Purchase Price</option>
										<option class="pricelist" value='-2'>Last Evaluated Price</option>
									<?php
										$itemno = 1;
										$qry = odbc_exec($MSSQL_CONN, "USE [".$MSSQL_DB."]; SELECT T0.ListNum, T0.ListName, T0.Factor from OPLN T0
																								ORDER BY T0.ListNum ASC");
										while (odbc_fetch_row($qry)) 
										{
											echo '<option class="pricelist" value='. odbc_result($qry, "ListNum").'>'. odbc_result($qry, "ListName") .'</option>';
					...
					<div class="form-group row  py-0 my-0 mb-1" >
						<label for="inputEmail3" class="col-sm-5 col-form-label " style="color: black;" >Ref. 2</label>
							<div class="col-sm-1 " >
							</div>
							<div class="col-sm-6" >
							  <input type="email" class="form-control d-none" id="txtStatus" placeholder=""  value="" readonly>
							   <input type="email" class="form-control" id="txtRef2" placeholder=""  value="" >
							</div>
						</div>	
  ...
  <li class="nav-item">
    <a class="nav-link d-none" id="" data-toggle="tab" href="#logistics" role="tab" aria-controls="logistics"
      aria-selected="false" style="color: black; font-weight:bold">Logistics</a>
  </li>
  <li class="nav-item">
    <a class="nav-link d-none" id="" data-toggle="tab" href="#accounting" role="tab" aria-controls="contact"
      aria-selected="false"  style="color: black; font-weight:bold">Accounting</a>
  </li>
 
</ul>

<div class="tab-content" id="myTabContent" style="padding-top: 10px; padding-bottom: 100px !important">
        ...
        <!-- /.container-fluid -->
				...
				<div class="row pr-0 "  width="100%">
					<div class="col-lg-5 pb-2" >
						<div class="form-group row  py-0 my-0 d-none">
						<div class="col-sm-3" >
						<label for="inputEmail3" class=" col-form-label " style="color: black;" >Buyer</label>
						</div>
							<div class="col-sm-9" >
				...
				<div  id="footerButtons" class="form-group row  mt-5 ">
					...
					<div class="col-lg-6 col-md-6 col-sm-6 text-right">
								...
								<button type="button" id="btnCopyFrom"  data-toggle="dropdown"  class="dropdown-toggle  btn btn-warning btn-rounded dropdown-toggle" style="color: black; font-weight: bold; width:250px; background: linear-gradient(to bottom, #FCF6BA, #BF953F);" >Copy From</button>			
								  <ul class="dropdown-menu " aria-labelledby="btnCopyFrom" style="color: black; font-weight: bold; width:250px; background-color: #fdfd96;">
									<li><button type="button" id="btnCopyFromPO" class="dropdown-item" style="color: black; font-weight: bold; font-size:15px;" data-toggle="modal" data-target="#goodsIssueModal" data-backdrop="false">Goods Issue</button></li>
								  </ul>
								</span>
					</div>
...
<!-- Logout Modal-->
  ...
  <!-- Document Modal -->
	...
	<!-- Copy From PO Modal -->
    <div class="modal fade" id="goodsIssueModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
      <div class="modal-dialog modal-xl" role="document" style="width:100%">
        <!--Content-->
        <div class="modal-content-full-width modal-content">
          <!--Header-->
           ...
           <table class="table table-striped table-bordered table-hover" id="tblItem" style="width:100%">
						<thead>
							<tr>
								...
								<th class="d-none">Last Purchase Price</th>
							</tr>
						</thead>
						<tbody>
						<?php
							...
							$qry = odbc_exec($MSSQL_CONN, "USE [".$MSSQL_DB."]; SELECT DISTINCT
								...
								while (odbc_fetch_row($qry)) 
								{
									...
									echo '<tr class="">
												...
												<td class="item-14 hidden" >'.number_format(odbc_result($qry, 'LastPurPrc'),2).'</td>
											  </tr>';
									$itemno++;	  
								}
    ...
    <div class="modal fade" id="batchModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document" style="width:100%; ">
        ...
        <div class="modal-content-full-width modal-content" style="height:1200px; width:1400px !important; margin-bottom:50px">
		  ...
		  <div id="batchTableReport" class="table-responsive" style="width:100%; height:500px !important; padding-bottom:20px; padding-left:10px;  overflow:scroll;" >
			...
			<table id="tblBatchCreated" class="table table-striped table-bordered table-sm detailsTable" cellspacing="0"  style="background-color: white; width= 100%" cellspacing="0">
						<thead>
							<tr >
								<th style="min-width:50px;position: sticky;top: 0; " >#</th>
								<th  style="min-width:250px;position: sticky;top: 0; ">Batch</th>
								<th  style="min-width:120px;position: sticky;top: 0; ">Qty</th>
								<th  style="min-width:120px;position: sticky;top: 0; ">Expiration Date</th>
								<th  style="min-width:120px;position: sticky;top: 0;  ">Mfr Date</th>
								<th  style="min-width:120px;position: sticky;top: 0;  ;">Admission Date</th>
          ...
          <!--Footer-->
          <div id="btnFooterGroup1" class="modal-footer">
							<button type="button" id="btnOkBatch" class="btn btn-secondary " data-dismiss="modal">Ok</button>
          	  <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
          </div>
          <div id="btnFooterGroup2" class="modal-footer d-none">
						<button type="button" id="btnUpdateBatch" class="btn btn-secondary"  >Update</button>
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
          </div>
        </div>
        <!--/.Content-->
...
<script src="../script/goods-receipt.js"></script>
