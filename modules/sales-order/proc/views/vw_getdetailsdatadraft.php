...
$qry = odbc_exec($MSSQL_CONN, "USE [".$MSSQL_DB."];
	...
	LEFT JOIN OWHS T4 ON T0.WhseCode = T4.WhseCode
...
while (odbc_fetch_row($qry)) 
{
	...
	$WhseCode = odbc_result($qry, "WhseCode");
	$WhseNam = odbc_result($qry, "WhseName");
	...
	if($DocStatus != 'O'){
		...
		$disabled = 'disabled';
				...
				if($docType == 'I'){
					...
					'<tr style="background-color: white; "  >
					  ...
					  <td >
					<div class="'.$inputGroup.'">
				<input type="text" class="form-control matrix-cell whsecode"  aria-label="" aria-describedby="button-addon2" style="outline: none; border:none" value="'.$WhseCode.'"readonly/>
		...
		<input type="hidden" class="form-control matrix-cell whsename"  aria-label="" aria-describedby="button-addon2" style="outline: none; border:none" value="'.$WhseName.'"/>
		</div>
	  </td>
	  <td >
		<div class="input-group ">
		<input type="text" class="form-control matrix-cell whsename"  aria-label="" aria-describedby="button-addon2" style="outline: none; border:none"  value="'.$WhseName.' readonly/>
		<input type="hidden" class="form-control matrix-cell whsecode"  aria-label="" aria-describedby="button-addon2" style="outline: none; border:none" value="'.$WhseCode.'/>
		</div>
	  </td>
	  <td >
	  <div class="'.$inputGroup.' ">
	   <input type="text" class="form-control matrix-cell text-right quantity" value="'.$Quantity.'" aria-label="" aria-describedby="button-addon2" style="outline: none; border:none" maxlength="12" />
					   ...
					   <td >
							<div class="'.$inputGroup.'" >
								<input type="hidden" class="form-control text-right  taxamount" value="'.$TaxAmount.'" style="outline: none; border:none" maxlength="8" '.$disabled.'/>
					...
					echo '<tr style="background-color: white; "  >
						...
						<ul class="dropdown-menu rowfunctions" role="menu" style="background-color: #fdfd96;">
						  ...
						  <td >
						   ...
						   <td class="d-none">
							<input type="text" class="form-control matrix-cell text-right quantity"  value="'.$Quantity.'" aria-label="" aria-describedby="button-addon2" style="outline: none; border:none" maxlength="12" value="1"/>
