            ...
            <div class="card-header py-0"  style="background-color: #A8A8A8; border-bottom-width: thick; border-color: #f0ad4e;">
				<div class="row" id="window-header">
					<div class="col-lg-6 col-md-6 col-sm-6">
						<h5 class="mt-2 font-weight-bold " style="color: black;">Sales Quotation</h5>
					</div>
				</div>
            </div>
								...
								<select type="text" class="form-control " id="selSeries" placeholder=""    >
									...
									<?php
												...
												$qry = odbc_exec($MSSQL_CONN, "USE [".$MSSQL_DB."]; SELECT DISTINCT
																											...
																											FROM NNM1 T0
																											WHERE T0.SeriesName = 'Primary' AND ObjectCode = 23
...
<div class="tab-content" id="myTabContent" style="padding-top: 10px;">
	...
	<div class="form-group row  mb-0" >
		...
		<label for="inputEmail3" class="col-sm-4 col-form-label pr-0" style="color: black; font-size:15px" >Item/Service Type</label>
			<select id="selTransactionType" class="col-sm-3 form-control-sm mdb-select md-form text-left" searchable="Search here.." style=" outline:none; border-color: #D0D0D0 !important">
	...
	<div class="tab-pane fade " id="attachments" role="tabpanel" aria-labelledby="attachments">
        ...
        <!-- /.container-fluid -->
				...
				<div  id="footerButtons" class="form-group row  mt-5 ml-5 ">
					<button type="button" id="btnAdd" class="  btn btn-warning btn-rounded " style="color: black;width:250px; background: linear-gradient(to bottom, #FCF6BA, #BF953F);" >Add</button>
					<button type="button" id="btnUpdate" class="  btn btn-warning btn-rounded d-none" style="color: black;width:250px; background: linear-gradient(to bottom, #FCF6BA, #BF953F);" >Update</button>
					<button type="button" id="btnCancel" class=" btn btn-warning btn-rounded ml-5" style="color: black;width:250px; background: linear-gradient(to bottom, #FCF6BA, #BF953F);">Cancel</button>
				</div>
            </form>
  ...
  <!-- Business Partner Modal -->
   ...
   <!-- Item Code Modal -->
            ...
            <table class="table table-striped table-bordered table-hover" id="tblItem" style="width:100%">
						...
						<?php
							...
							$qry = odbc_exec($MSSQL_CONN, "USE [".$MSSQL_DB."]; SELECT DISTINCT
																						...
																						INNER JOIN OITM T5 ON T5.OnHand = T0.OnHand
    ...
    <div class="modal fade" id="stateModalS" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
	 ...
	 <!--BILL TO STATE MODAL -->
	 <div class="modal fade" id="stateModalB" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
      <div class="modal-dialog modal-xl" role="document" style="width:100%">
        <!--Content-->
        <div class="modal-content-full-width modal-content">
          <!--Header-->
    ...
    <!-- UDF -->
<script src="../script/sales-quotation-utilities.js"></script>
<script src="../script/sales-quotation.js"></script>
