...
<?php
	$GoodsreceiptArr = array(
		"cardType" => "S",
		"taxCodeCategory" => "I",
		"mainFileName" => "goods-receipt-PO",
		"objectTableName" => "Goods Receipts PO",
		"objectTable" => "OPDN",
		"objectType" => 20,
		"childTable1" => "PDN1",
		"childTable12" => "PDN12",
	...
	$_SESSION['GoodsreceiptArr'] = json_encode($GoodsreceiptArr);

	$_SESSION['cardType'] = $GoodsreceiptArr['cardType'];
	$_SESSION['mainFileName'] = $GoodsreceiptArr['mainFileName'];
	$_SESSION['objectTableName'] = $GoodsreceiptArr['objectTableName'];
	$_SESSION['objectTable'] = $GoodsreceiptArr['objectTable'];
	$_SESSION['objectType'] = $GoodsreceiptArr['objectType'];
?>

	<script type="text/javascript">
		let obj = JSON.parse('<?php echo $_SESSION['GoodsreceiptArr']; ?>');
    ...
    <div class="modal fade" id="documentModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog modal-xl" role="document" style="width:100%">
            ...
            <div class="modal-content-full-width modal-content">
                ...
                <div class="modal-header"
                    style="background-color: #A8A8A8; border-bottom-width: thick; border-color: #f0ad4e;">
                    <h4 class="modal-title w-100" id="myModalLabel" style="color:black">List of A/P Downpayment Invoice</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
