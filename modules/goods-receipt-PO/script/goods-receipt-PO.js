...
//Double Clicks
	...
	$(document.body).on('dblclick', '#tblBP tbody > tr', function () 
	{
		...
		$('#txtJournalMemo').val('Goods Receipt PO - ' + cardCode);
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------		
		...
		setTimeout(function () 
			{
						...
						$('#rowLoader').load('../templates/goods-receipt-PO-serial-creation-lines.php', function (result) 
						{
	...
	function GetAllItemWithSerialManagement(){
		...
		for(let i = 0; i < length; i++){
			...
			$('#tblSerialCreated > tbody').load('../templates/goods-receipt-PO-serial-creation-lines.php');
