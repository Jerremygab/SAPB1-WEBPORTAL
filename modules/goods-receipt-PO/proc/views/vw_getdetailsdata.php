...
$objSession = json_decode($_SESSION['GoodsreceiptArr']);
	...
	if($ManBtchNum == 'Y'){
		...
		$hasBatchSerial = '';
				...
				if($docType == 'I'){
					...
					$PriceAfVat = number_format($PriceAfVat,2);
					...
					'<tr style="background-color: white; "  >
					  ...
					  <td >
						...
						<input type="hidden" class="form-control visorder"  style="outline: none; border:none; " readonly value="'.$VisOrder.'" />
						  <button class="btn '.$buttonHide.' "  type="button" data-mdb-ripple-color="dark"  style="background-color: #ADD8E6; "  data-toggle="modal" data-target="#itemModal" data-backdrop="false" disable>
					  ...
					  <td >
					   ...
					   <div class="'.$inputGroup.' ">
						...
						<td >
						<input type="text" class="form-control matrix-cell text-right price" value="'.$Price.'"  aria-label="" aria-describedby="button-addon2" style="outline: none; border:none" maxlength="30" />
					   ...
					   <td >
						<input type="text" class="form-control matrix-cell text-right grossprice"  value="'.$PriceAfVat.'" aria-label="" aria-describedby="button-addon2" style="outline: none; border:none" maxlength="30"  />
					...
					echo '<tr style="background-color: white; "  >
						  ...
						  <td >
						   ...
						   <td class="d-none">
							<input type="text" class="form-control matrix-cell text-right quantity"  value="1" aria-label="" aria-describedby="button-addon2" style="outline: none; border:none" maxlength="30" value="1" readonly/>
						   ...
						   <td >
								<div class="'.$inputGroup.' ">
									<input type="hidden" class="form-control text-right  taxamount"  value="'.$TaxAmount2.'"  style="outline: none; border:none" maxlength="30" readonly/>
						   ...
						   <td >
							<input type="text" class="form-control matrix-cell text-right grossprice"    value="'.$PriceAfVat.'"  style="outline: none; border:none" maxlength="30" />
		...
		if($docType == 'I'){
					...
					'<tr style="background-color: white; "  >
					  ...
					  <td >
					   ...
					   <td >
					   <div class="'.$inputGroup.' ">
						<input type="text" class="form-control matrix-cell text-right quantity"  aria-label="" aria-describedby="button-addon2" style="outline: none; border:none" maxlength="30" readonly/>
						...
						<td >
						<input type="text" class="form-control matrix-cell text-right discount"   style="outline: none; border:none" maxlength="30" readonly/>
					   ...
					   <td >
						<input type="text" class="form-control matrix-cell text-right grossprice"   aria-label="" aria-describedby="button-addon2" style="outline: none; border:none" maxlength="30"/>
					...
					echo '<tr style="background-color: white; "  >
						  ...
						  <td >
						   ...
						   <td >
							...
							<input type="text" class="form-control matrix-cell text-right grossprice"      style="outline: none; border:none" maxlength="30"/>
