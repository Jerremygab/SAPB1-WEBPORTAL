...
$postedorDraft = $_GET['postedorDraft'];
$docentryString = '';
...
$qry = odbc_exec($MSSQL_CONN, "USE [".$MSSQL_DB."];
	...
	WHERE " .$docentryString. " IN ( $docNum ) AND T0.ObjType = $objType
				...
				if($docType == 'I'){
					...
					'<tr style="background-color: white; "  >
					  ...
					  <td >
						...
						<input type="text" class="form-control baseentry d-none"   style="outline: none; border:none; " value="'.$DocEntry.'" readonly/>
						<input type="text" class="form-control linenum d-none"   style="outline: none; border:none; " value="'.$LineNum.'" readonly/>
					...
					echo '<tr style="background-color: white; "  >
						  ...
						  <td >
							...
							<input type="hidden" class="form-control baseentry d-none"   style="outline: none; border:none; " value="'.$DocEntry.'" readonly/>
							<input type="hidden" class="form-control linenum d-none"   style="outline: none; border:none; " value="'.$LineNum.'" readonly/>
							<input type="hidden" class="form-control visorder"  style="outline: none; border:none; " readonly value="'.$VisOrder.'" />
