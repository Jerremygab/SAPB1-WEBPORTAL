            ...
            <div class="card-header py-0" style="background-color: #A8A8A8; border-bottom-width: thick; border-color: #f0ad4e;">
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-6">
						...
						<h5 class="mt-2 font-weight-bold " style="color: black;" id="ApprovalTemplateCode">ApprovalTemplateCode: <?php echo $ApprovalTemplateCode; ?></h5>
						<h5 class="mt-2 font-weight-bold " style="color: black;" id="OriginatorEmpId">OriginatorEmpId: <?php echo $OriginatorEmpId; ?></h5>
						<h5 class="mt-2 font-weight-bold " style="color: black;" id="ApprovalStageCode">ApprovalStageCode: <?php echo $ApprovalStageCode; ?></h5>
						<h5 class="mt-2 font-weight-bold " style="color: black;" id="ApproverEmpId">ApproverEmpId: <?php echo $ApproverEmpId; ?></h5>
						<h5 class="mt-2 font-weight-bold " style="color: black;" id="ApprovalModules">ApprovalModules: <?php echo $ApprovalModules; ?></h5>
						<h5 class="mt-2 font-weight-bold " style="color: black;" id="NoOfApprovals">NoOfApprovals: <?php echo $NoOfApprovals; ?></h5>
						<h5 class="mt-2 font-weight-bold " style="color: black;" id="NoOfDisapprovals">NoOfDisapprovals: <?php echo $NoOfDisapprovals; ?></h5>
					</div>
			...
			<form class="user responsive " id="form"  width="100%" enctype="multipart/form-data">
				...
				<div class="col-lg-4 pb-2" id="bpCol">
					...
					<div class="col-lg-4 pb-2 " id="dateCol">
						...
						<div class="form-group row  py-0 my-0 mb-1" >
						<label for="inputEmail3" class="col-sm-5 col-form-label " style="color: black;" >Approval Status</label>
							<div class="col-sm-1 " >
							</div>
							<div class="col-sm-6" >
							  <input type="email" class="form-control" id="txtApprovalStatus" placeholder=""  value="" readonly disabled="disabled">
							</div>
						</div>	
						<div class="form-group row  py-0 my-0" >
