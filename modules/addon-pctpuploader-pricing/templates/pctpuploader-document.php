		...
		<form class="user responsive " id="form"  width="100%">
			<div class="row pr-0 pb-2"  width="100%">
				...
				<div class="col-12 ml-auto my-3 text-center">
					<span class="col-2 d-none" style="color: black; font-weight:bold; font-size: 40px; border-right: 1px solid black;">ITEM
					...
					<span class="col-2 " style="color: black; font-weight:bold; font-size: 40px; border-right: 1px solid black;">PRICING
						<span id="" class="text-success" style="font-size: 20px ">
					...
					<br/>
					<span class="col-2 " style="color: black; font-weight:bold; font-size: 40px; border-right: 1px solid black;">CLIENT
						<span id="" class="text-success" style="font-size: 20px ">
							<div class="spinner-border text-primary clientloading mb-2 d-none" role="status">
							  <span class="sr-only">Loading...</span>
							</div>
							<span class="clientcheck d-none" style="font-size: 30px "><i class="fa fa-check"  ></i></span>
							<span class="clientuploaded" style="font-size: 30px ">0</span> /
							<span class="clientoverall " style="font-size: 30px ">0</span>
						</span>
					</span>
					<span class="col-2 " style="color: black; font-weight:bold; font-size: 40px; ">TRUCKER
						<span id="" class="text-success" style="font-size: 20px ">
							<div class="spinner-border text-primary truckerloading mb-2 d-none" role="status">
							  <span class="sr-only">Loading...</span>
							</div>
							<span class="truckercheck d-none" style="font-size: 30px "><i class="fa fa-check"  ></i></span>
							<span class="truckeruploaded " style="font-size: 30px ">0</span> /
							<span class="truckeroverall " style="font-size: 30px ">0</span>
						</span>
					</span>
				</div>
